...
| Topic | Location |
|-------|----------|
| Build pipeline flow | [README.md § How it works](../README.md#how-it-works) |
| UI ↔ Core layers | [ARCHITECTURE.md § Layer diagram](ARCHITECTURE.md#layer-diagram) |
| Folder classification | [FOLDER_PATTERNS.md § Decision flow](FOLDER_PATTERNS.md#decision-flow) |
| Sequence: one build | [ARCHITECTURE.md § Data flow](ARCHITECTURE.md#data-flow-one-build) |
